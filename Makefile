...
education: $(SOURCES)
	$(CXX) $(CPPFLAGS) $(CXXFLAGS) tests/education_tests.cpp src/education/EducationChallenges.cpp src/education/EducationContent.cpp src/education/EducationProgress.cpp src/physics/PhysicsEngine.cpp src/physics/IntegratorBenchmark.cpp -o bagsolar_education_tests
